...
const LEGACY_GENERATED_DIR = join(__scriptDir, '../src/lib/convex/emails/_generated');
...
async function buildEmails() {
	...
	// Existing clones may still carry the old ignored output after pulling the
	// migration. Delete it before Convex discovers those files as function entry
	// points; every file there is regenerated by this script.
	rmSync(LEGACY_GENERATED_DIR, { recursive: true, force: true });
