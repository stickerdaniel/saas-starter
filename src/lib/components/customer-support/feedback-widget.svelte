...
<div
	class="fixed right-0 bottom-0 z-1 flex h-svh w-full origin-bottom motion-safe:animate-in flex-col overflow-hidden bg-secondary shadow-[0_0px_30px_rgba(0,0,0,0.19)] motion-safe:duration-200 ease-out motion-safe:fade-in-0 motion-safe:zoom-in-95 motion-safe:slide-in-from-bottom-4 md:relative md:h-[700px] md:max-h-[calc(100svh-3rem-0.75rem-1.25rem-1.25rem)] md:w-[410px] md:origin-bottom-right md:rounded-3xl"
>
